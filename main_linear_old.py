...
class AgeDB(data.Dataset):
    def __init__(self, opt, data_folder, transform=None, split='train', noise_scale=0.0, feature_dim=512):
...
def set_loader(opt):
    ...
    train_dataset = globals()[opt.dataset](opt, data_folder=opt.data_folder, transform=train_transform, split='train', noise_scale=opt.noise_scale)
